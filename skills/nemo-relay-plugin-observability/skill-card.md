## Description: <br>
Use this skill when choosing or configuring NeMo Relay observability through the built-in plugin, subscribers, or exporters, including raw ATOF events, ATIF trajectories, typed OpenTelemetry projections, or custom event handling. <br>
